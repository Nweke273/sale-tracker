...
Route::middleware('auth:sanctum')->group(function () {
    ...
    //Case
    Route::get('/cases/{id}', [LeadController::class, 'leadCase']);
    Route::put('/cases/{id}/update', [LeadController::class, 'updateCase']);
    Route::delete('/cases/{id}/delete', [LeadController::class, 'deleteCase']);
    Route::get('/cases', [LeadController::class, 'cases']);
